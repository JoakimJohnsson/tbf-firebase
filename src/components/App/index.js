...
import { faWrench, faHome, faRecordVinyl, faMusic } from '@fortawesome/free-solid-svg-icons'
...
library.add(faAirbnb, faGoogle, faFacebookF, faArrowAltCircleLeft, faCopyright, faWrench, faHome, faRecordVinyl, faMusic);
